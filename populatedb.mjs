...
function authorCreate(firstName, familyName, dBirth, dDeath, cb) {
  const authordetail = { firstName, familyName }
  if (dBirth != false) authordetail.dateOfBirth = dBirth
  if (dDeath != false) authordetail.dateOfDeath = dDeath
...
function createBookinstances(cb) {
    async.parallel([
        function(callback) {
          bookinstanceCreate(books[0], 'London Gollancz, 2014.', false, 'Доступен', callback)
        },
        function(callback) {
          bookinstanceCreate(books[1], ' Gollancz, 2011.', false, 'Одолжен', callback)
        },
        function(callback) {
          bookinstanceCreate(books[2], ' Gollancz, 2015.', false, false, callback)
        },
        function(callback) {
          bookinstanceCreate(books[3], 'New York Tom Doherty Associates, 2016.', false, 'Доступен', callback)
        },
        function(callback) {
          bookinstanceCreate(books[3], 'New York Tom Doherty Associates, 2016.', false, 'Доступен', callback)
        },
        ...
        function(callback) {
          bookinstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', false, 'Доступен', callback)
        },
        function(callback) {
          bookinstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', false, 'Обслуживание', callback)
        },
        function(callback) {
          bookinstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', false, 'Одолжен', callback)
        },
        function(callback) {
